...
namespace FiftyOne.UnitTests.Performance.Premium
{
    ...
    public class TrieAll : TrieBase
    {
        ...
        [TestMethod]
        [TestCategory("Premium"), TestCategory("Trie"), TestCategory("Performance"), TestCategory("Multi"), TestCategory("Bad"), TestCategory("All")]
        ...
        [TestMethod]
        [TestCategory("Premium"), TestCategory("Trie"), TestCategory("Performance"), TestCategory("Single"), TestCategory("Bad"), TestCategory("All")]
        ...
        [TestMethod]
        [TestCategory("Premium"), TestCategory("Trie"), TestCategory("Performance"), TestCategory("Multi"), TestCategory("Unique"), TestCategory("All")]
        ...
        [TestMethod]
        [TestCategory("Premium"), TestCategory("Trie"), TestCategory("Performance"), TestCategory("Single"), TestCategory("Unique"), TestCategory("All")]
        ...
        [TestMethod]
        [TestCategory("Premium"), TestCategory("Trie"), TestCategory("Performance"), TestCategory("Multi"), TestCategory("Random"), TestCategory("All")]
        ...
        [TestMethod]
        [TestCategory("Premium"), TestCategory("Trie"), TestCategory("Performance"), TestCategory("Single"), TestCategory("Random"), TestCategory("All")]
