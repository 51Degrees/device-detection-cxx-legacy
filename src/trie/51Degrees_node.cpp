...
static SwigV8ReturnValue _wrap_new_Provider__SWIG_2(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  ...
  int res2 = 0 ;
  Provider *result;
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_Provider__SWIG_2.");
  {
    std::string *ptr = (std::string *)0;
    res1 = SWIG_AsPtr_std_string(args[0], &ptr);
    if (!SWIG_IsOK(res1)) {
...
NODE_MODULE(FiftyOneDegreesTrieV3, FiftyOneDegreesTrieV3_initialize)
#endif
