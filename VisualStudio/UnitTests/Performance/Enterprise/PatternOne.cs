...
namespace FiftyOne.UnitTests.Performance.Enterprise
{
    ...
    public class PatternOne : PatternBase
    {
        ...
        [TestMethod]
        [TestCategory("Enterprise"), TestCategory("Pattern"), TestCategory("Performance"), TestCategory("Multi"), TestCategory("Bad"), TestCategory("One")]
        ...
        [TestMethod]
        [TestCategory("Enterprise"), TestCategory("Pattern"), TestCategory("Performance"), TestCategory("Multi"), TestCategory("Unique"), TestCategory("One")]
        ...
        [TestMethod]
        [TestCategory("Enterprise"), TestCategory("Pattern"), TestCategory("Performance"), TestCategory("Single"), TestCategory("Unique"), TestCategory("One")]
        ...
        [TestMethod]
        [TestCategory("Enterprise"), TestCategory("Pattern"), TestCategory("Performance"), TestCategory("Multi"), TestCategory("Random"), TestCategory("One")]
        ...
        [TestMethod]
        [TestCategory("Enterprise"), TestCategory("Pattern"), TestCategory("Performance"), TestCategory("Single"), TestCategory("Random"), TestCategory("One")]
