![51Degrees](https://51degrees.com/DesktopModules/FiftyOne/Distributor/Logo.ashx?utm_source=github&utm_medium=repository&utm_content=readme_main&utm_campaign=node-open-source "THE Fastest and Most Accurate Device Detection") **Device Detection in C** Node.js Trie Data
...
Lite Trie data file for fiftyonedegreescore module.

use like ...
```js
var dataFile = require('fiftyonedegreeslitetrie');
```
