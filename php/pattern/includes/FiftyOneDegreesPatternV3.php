...
class Provider {
	...
	function __construct($fileName,$propertyString_or_propertiesArray_or_cacheSize=null,$cacheSize_or_poolSize=null,$poolSize=null) {
		...
		default: $this->_cPtr=new_Provider($fileName,$propertyString_or_propertiesArray_or_cacheSize,$cacheSize_or_poolSize,$poolSize);
		}
	}
	...
	function getMatch($userAgent_or_headers) {
		...
		case '_p_Match': return new Match($r);
		default: return new Match($r);
		}
	}
	...
	function findProfiles($propertyName,$valueName,$profiles=null) {
		if (!is_resource($r)) return $r;
		switch (get_resource_type($r)) {
		case '_p_Profiles': return new Profiles($r);
		default: return new Profiles($r);
		}
	}
